      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-16 max-w-2xl">
          ...
          <p className="mt-4 text-secondary text-lg leading-relaxed">
            Custom websites, AI automation, SaaS platforms, dashboards, ecommerce stores, restaurant
            ordering systems, and business software — built for startups, local businesses, and
            growing companies.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {services.map((s, i) => (
            ...
            >
              <Link
                href={`/${s.slug}`}
                className="group card-surface p-8 hover:[border-color:var(--hover-border)] hover:bg-black/[0.02] relative overflow-hidden block h-full"
              >
                <div
                  aria-hidden
                ...
                <p className="mt-2 text-secondary leading-relaxed text-sm">{s.tagline}</p>
